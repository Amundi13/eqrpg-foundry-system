...
- Release download: `https://github.com/Amundi13/eqrpg-foundry-system/releases/latest/download/eqrpg-foundry-system-v0.1.9.zip`

## Release

1. Update `system.json` with the next version.
2. Commit and push the changes to `main`.
3. Create and push a matching tag, for example `v0.1.9`.
...
GitHub Actions will publish `system.json` and `eqrpg-foundry-system-v0.1.9.zip` to the release. Use the manifest URL above in Forge so Forge/Foundry can detect newer published versions.
