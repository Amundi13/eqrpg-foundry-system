...
- Release download: `https://github.com/Amundi13/eqrpg-foundry-system/releases/latest/download/eqrpg-foundry-system-v0.1.8.zip`
...
GitHub Actions will publish `system.json` and `eqrpg-foundry-system-v0.1.8.zip` to the release. Use the manifest URL above in Forge so Forge/Foundry can detect newer published versions.
